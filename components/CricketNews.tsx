...
import { cricketNewsData } from "@/data/mockData";
  ...
  return (
    <section className="news-section bg-card rounded-3 p-4 border border-dark mt-4 font-outfit">
      <div className="d-flex justify-content-between align-items-center mb-4">
        ...
        <Link href="/news?category=Cricket" className="text-success text-decoration-none small fw-medium">
          View All
        </Link>
      </div>

      <div className="d-flex flex-column gap-3">
        {cricketNewsData.map((item: NewsItem, index: number) => {
